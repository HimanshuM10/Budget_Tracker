...
function CreateTransitionDialog({trigger,type}: Props) {
    ...
    const {mutate,isPending} = useMutation({
        ...
        onSuccess: ()=>{
            ...
            //After creating a transactiob , we need to invalidate the overview query which will refresh data in the homepage
                        ...
                        <FormItem className="flex flex-col">
                            ...
                            <Popover>
                                <PopoverTrigger asChild>
                                    <FormControl>
                                        <Button variant={"outline"} className={cn("w-[200px] pl-3 text-left font-normal",
                                ...
                                <PopoverContent className="w-auto p-0">
                                    <Calendar mode="single" selected={field.value} onSelect={value =>{
                                        if(!value){ return;}
                                        console.log("@@CALENDER",value); field.onChange(value);
                                    }} initialFocus />
                                </PopoverContent>
                            </Popover>
                            <FormDescription>
...
export default CreateTransitionDialog